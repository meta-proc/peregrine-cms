...
public class CreateDistributionUsersAndPermissions
    ...
    protected void createPermissions(Session session, Principal principal) throws RepositoryException {
        ...
        AccessControlUtils.addAccessControlEntry(session, "/", principal, new String[]{Privilege.JCR_ALL}, true);
        ...
        AccessControlUtils.addAccessControlEntry(session, LIBS, principal, new String[]{Privilege.JCR_ALL}, true);
        AccessControlUtils.addAccessControlEntry(session, APPS, principal, new String[]{Privilege.JCR_ALL}, true);
